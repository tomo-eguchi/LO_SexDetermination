...
if (!file.exists("RData/LO_sex_tail_SCL_v2.rds")){
  ...
  saveRDS(jm.out, file = "RData/LO_sex_tail_SCL_v2.rds")
}
...
sex_tail_SCL  <- readRDS("RData/LO_sex_tail_SCL_v2.rds")
DICs <- c(sex_only$jm.out$DIC, sex_tail$jm.out$DIC, sex_tail_SCL$DIC)
DICs
```

We should also use Pareto k statistic to see if the model fit right. 
...
write.csv(dat.1, 
          file = "data/estimated_sex_LO_ETP_v2.csv",
