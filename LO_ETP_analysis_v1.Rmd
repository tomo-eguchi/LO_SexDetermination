...
rm("sex_tail")
sex_tail2 <- readRDS("RData/LO_sex_tail2.rds")
DIC_sex_tail2 <- sex_tail2$jm.out$DIC
rm("sex_tail2")
sex_tail_SCL  <- readRDS("RData/LO_sex_tail_SCL.rds")
DIC_sex_tail_SCL <- sex_tail_SCL$jm.out$DIC
rm("sex_tail_SCL")
sex_tail2_SCL  <- readRDS("RData/LO_sex_tail2_SCL.rds")
DIC_sex_tail2_SCL <- sex_tail2_SCL$jm.out$DIC
rm("sex_tail2_SCL")
sex_ptail <- readRDS("RData/LO_sex_ptail.rds")
DIC_sex_ptail <- sex_ptail$jm.out$DIC
rm("sex_ptail")
sex_ptail2 <- readRDS("RData/LO_sex_ptail2.rds")
DIC_sex_ptail2 <- sex_ptail2$jm.out$DIC
rm("sex_ptail2")
sex_ptail_SCL  <- readRDS("RData/LO_sex_ptail_SCL.rds")
DIC_sex_ptail_SCL <- sex_ptail_SCL$jm.out$DIC
rm("sex_ptail_SCL")
sex_ptail2_SCL  <- readRDS("RData/LO_sex_ptail2_SCL.rds")
DIC_sex_ptail2_SCL <- sex_ptail2_SCL$jm.out$DIC
rm("sex_ptail2_SCL")
DICs <- data.frame(Model = c("sex_only", "sex_tail", "sex_tail2",
                       "sex_tail_SCL", "sex_tail2_SCL",
                       "sex_ptail", "sex_ptail2",
                       "sex_ptail_SCL", "sex_ptail2_SCL"),
             DIC = c(DIC_sex, DIC_sex_tail, DIC_sex_tail2, 
                     DIC_sex_tail_SCL, DIC_sex_tail2_SCL, 
                     DIC_sex_ptail, DIC_sex_ptail2, 
                     DIC_sex_ptail_SCL, DIC_sex_ptail2_SCL))
DICs
```
